...
<div class="timeline">
  <div class="container right">
    <div class="content">
	  ...
	  <a href="Bill1.jsp?id=<%=resultSet.getString("eid")%>"><button> Show Bill </button></a><br><br>
	  <a href="eventDeleteServlet?id=<%=resultSet2.getString("eid")%>"><button>Delete</button><a>
    </div>
  </div>
</div>
